...
public class SecuredVaultContainer extends GenericContainer<SecuredVaultContainer> implements TestLifecycleAware {
    ...
    public void setupKubernetesRoleAuth(Path kubeConfigFile, String workloadSA, String reviewerToken)
        ...
        runCommand(
            ...
            "kubernetes_host=" + "https://host.docker.internal:" + kubernetesConfig.getApiServerPort(),
