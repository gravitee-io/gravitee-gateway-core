...
public class SearchApplicationConnectionLogsUseCase {
    ...
    public SearchApplicationConnectionLogsUseCase(
    ...
    public Output execute(ExecutionContext executionContext, Input input) {
        ...
        var response = connectionLogsCrudService.searchApplicationConnectionLogs(executionContext, input.applicationId(), input.logsFilters(), pageable);
